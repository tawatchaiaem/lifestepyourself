...
<html lang="en-US">
  <head>
    ...
    <title>Tawatchai CV</title>
    
    <meta name="description" content="Tawatchai Creative CV "/>
    <link rel="icon" href="./images/text.png" type="image/png" sizes="16x16"> 
    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Tawatchai CV</a>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/bg-a.png');"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/img-pro.jpg" alt="Image"/></a></div>
          <div class="h2 title">Tawatchai Hona</div>
          <p class="category text-white">Programmer</p>
          <a class="btn btn-primary smooth-scroll mr-2" href="images/Transcript_EN.jpg" data-aos="zoom-in" data-aos-anchor="data-aos-anchor" target="_blank">Transcript View</a>
      ...
      <div class="section">
        <div class="container">
          <div class="button-container">
            <a class="btn btn-default btn-round btn-lg btn-icon" href="https://www.facebook.com/tawatchaihona" rel="tooltip" title="Follow me on Facebook" target="_blank">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>สวัสดีครับ ผมชื่อ ธวัชชัย  โห้นา หรือเรียกง่ายๆว่า "เอ็ม" ตอนนี้ทำงานเป็นโปรแกรมเมอร์</p>
            <p>ปัจจุบันผมทำงานเป็นโปรแกรมเมอร์</p>
            <p>โดยส่วนตัวแล้วผมเป็นคนที่ชอบเรียนรู้อะไรใหม่ๆอยู่ตลอดเวลา</p>
            <p>เพราะการเรียนรู้อะไรใหม่ๆ ทำให้ผมรู้สึกสนุกและได้พัฒนาตัวเองมากขึ้น</p>
            <p>ภาษาที่เขียน HTML, CSS, JavaScript, JQuery, PHP, PHP codeigniter, NodeJs</p>
            <p>ภาษาที่กำลังศึกษาเพิ่มเติม NodeJS, Golang, Java</p>
            <!-- <p>ผมเองไม่ใช่คนที่เก่งอะไรมากมาย พร้อมที่จะเรียนรู้และต่อยอด</p>
            <p>คติประจำใจ : ไม่เก่งไม่เป็นไรต้องขยันเพิ่มขึ้น</p> -->
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">ชื่อ :</strong></div>
              <div class="col-sm-8">ธวัชชัย โห้นา</div>
          </div>
          <div class="row mt-3">
            <div class="col-sm-4"><strong class="text-uppercase">ชื่อเล่น :</strong></div>
            <div class="col-sm-8">เอ็ม</div>
        </div>
          <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">ส่วนสูง :</strong></div>
              <div class="col-sm-8">171 ซ.ม.</div>
          </div>
          <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">น้ำหนัก :</strong></div>
              <div class="col-sm-8">73 ก.ก.</div>
          </div>
          <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">เพศ :</strong></div>
              <div class="col-sm-8">ชาย</div>
          </div>
          <div class="row mt-3">
          ...
          <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">สถานภาพการสมรส :</strong></div>
          ...
          <div class="row mt-3">
            ...
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">อีเมลล์ :</strong></div>
              <div class="col-sm-8">tawatchai.h1994.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">เบอร์โทร :</strong></div>
              <div class="col-sm-8">+092-680-9856</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">ที่อยู่ :</strong></div>
              <div class="col-sm-8">228/1, Tombon Phikwang, Amphoe Muang, Changwat Suphunburi, Thailand</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">ภาษา :</strong></div>
              <div class="col-sm-8">Thai, English</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Media query css</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 65%;"></div><span class="progress-value">65%</span>
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="progress-container progress-primary"><span class="progress-badge">PHP codeigniter</span>
                <div class="progress">
                  <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div><span class="progress-value">80%</span>
                </div>
              </div>
        ...
        <div class="row">
            <div class="col-md-6">
              <div class="progress-container progress-primary"><span class="progress-badge">Node JS </span>
                <div class="progress">
                  <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"></div><span class="progress-value">60%</span>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="progress-container progress-primary"><span class="progress-badge">Golang</span>
                <div class="progress">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">illustrator</span>
              <div class="progress">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="images/project-w.jpg" alt="Image"/>
                    <figcaption>
                      <div class="h4">วิทยานิพนธ์</div>
                      <p>เว็บไซต์บริหารจัดการครุภัณฑ์คอมพิวเตอร์หน่วยงานชุมชนสัมพันธ์โครงการ</p>
                    </figcaption>
                  </figure></a></div>
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="images/w2.jpg" alt="Image"/>
                    <figcaption>
                      <div class="h4">กรมบังคับคดี สำนักฟื้นฟูกิจการลูกหนี้</div>
                      <p>พัฒนาระบบฟื้นฟูกิจการลูกหนี้</p>
                    </figcaption>
                  </figure></a></div>
            </div>
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="images/tgo.png" alt="Image"/>
                    <figcaption>
                      <div class="h4">traveliGo</div>
                      <p>พัฒนาระบบ traveliGo</p>
                    </figcaption>
                  </figure></a></div>
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="images/cp.png" alt="Image"/>
                    <figcaption>
                      <div class="h4">Corporate</div>
                      <p>พัฒนาระบบ Corporate</p>
                    </figcaption>
                  </figure></a></div>
            </div>
          </div>
...
<div class="section" id="experience">
  <div class="container cc-experience">
      ...
      <div class="h4 text-center mb-4 title">ประวัติการทำงาน</div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>ต.ค. 2561 – ปัจจุบัน</p>
            <div class="h5">Programmer</div> 
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">ชื่อบริษัท : chaiyohosting</div>
            <!-- <p>ชื่อบริษัท : chaiyohosting</p> -->
            <p>ที่อยู่ : 3312/33-34 ชั้น 2-3 โซนเอ ซอยลาดพร้าว 101 ถนนลาดพร้าว แขวงคลองจั่น เขตบางกะปิ กรุงเทพมหานคร 10240</p>
            <p>รายละเอียดงาน : programmer php , programmer node js, javascript พัฒนาระบบเว็บไซต์</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>มี.ค. 2561 – ก.ย. 2561</p>
            <div class="h5">Programmer PHP</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">ชื่อบริษัท : Bizpotential</div>
              <p>ที่อยู่ : 807/1 ถนนพระราม 3 แขวงบางโพงพาง เขตยานนาวา กรุงเทพฯ 10120</p>
              <p>รายละเอียดงาน : พัฒนาระบบฟื้นฟูกิจการลูกหนี้</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>ส.ค. 2560 - มี.ค. 2561</p>
            <div class="h5">เจ้าพนักงานเครื่องคอมพิวเตอร์</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">ชื่อบริษัท : กรมชลประทาน</div>
            <p>ที่อยู่ :  811 ถ.สามเสน แขวงถนนนครไชยศรีเขตดุสิต กรุงเทพมหานคร 10300 </p>
            <p>รายละเอียดงาน : ดูแลระบบคอมพิวเตอร์และเน็ตเวิร์ค</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
        <div class="row">
          <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
            <div class="card-body cc-experience-header">
              <p>พ.ย. 2558 – ก.ย. 2560</p>
              <div class="h5">IT Support</div>
            </div>
          </div>
          <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
            <div class="card-body">
              <div class="h5">ชื่อบริษัท : อีทีอี เมเนจเมนท์</div>
              <p>ที่อยู่ : การไฟฟ้าฝ่ายผลิตแห่งประเทศไทย  53 หมู่ 2 ถ.จรัญสนิทวงศ์ ต.บางกรวย อ.บางกรวย จ.นนทบุรี 11130</p>
              <p>รายละเอียดงาน : ดูแลระบบคอมพิวเตอร์และเน็ตเวิร์ค</p>
            </div>
          </div>
        </div>
      ...
      <div class="card">
          <div class="row">
            <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
              <div class="card-body cc-experience-header">
                <p>เม.ย. 2557 - เม.ย. 2558</p>
                <div class="h5">พนักงานซ่อมคอมพิวเตอร์ และเครื่องปริ้นเตอร์</div>
              </div>
            </div>
            <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
              <div class="card-body">
                <div class="h5">ชื่อบริษัท : มิสเตอร์อิงค์ สุพรรณบุรี</div>
                <p>ที่อยู่ :  32/10-11 ถนนนางพิม ตำบลท่าพี่เลี้ยง อำเภอเมือง จังหวัดสุพรรณบุรี เทศบาลเมืองสุพรรณบุรี 72000</p>
                <p>รายละเอียดงาน : ซ่อมคอมพิวเตอร์ และเครื่องปริ้นเตอร์</p>
              </div>
            </div>
          </div>
        </div>
...
<div class="section" id="education">
  <div class="container cc-education">
    <div class="h4 text-center mb-4 title">ประวัติการศึกษา</div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">วิทยาการคอมพิวเตอร์</div>
            <p class="category">มหาวิทยาลัยเทคโนโลยีราชมงคลพระนคร วิทยาเขตพระนครเหนือ</p>
            <p>จังหวัดที่ตั้งสถาบัน : กรุงเทพมหานคร</p>
            <p>วุฒิการศึกษา : วิทยาศาสตรบัณฑิต(วท.บ)</p>
            <p>เกรด : 3.29</p>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2556 - 2558</p>
            <div class="h5">ปวส.</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">เทคนิคคอมพิวเตอร์</div>
            <p class="category">มหาวิทยาลัยเทคโนโลยีราชมงคลสุวรรณภูมิ</p>
            <p>จังหวัดที่ตั้งสถาบัน : สุพรรณบุรี</p>
            <p>วุฒิการศึกษา : ประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.)</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2553 - 2556</p>
            <div class="h5">ปวช.</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">อิเล็กทรอนิกส์</div>
            <p class="category">วิทยาลัยเทคนิคสุพรรณบุรี</p>
            <p>จังหวัดที่ตั้งสถาบัน : สุพรรณบุรี</p>
            <p>เกรด : 2.93</p>
          </div>
        </div>
    ...
    <div class="card">
        <div class="row">
          <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
            <div class="card-body cc-education-header">
              <p>2550 - 2553</p>
              <div class="h5">มัธยมศึกษา</div>
            </div>
          </div>
          <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
            <div class="card-body">
              <div class="h5">มัธยมศึกษา</div>
              <p class="category">โรงเรียนกาณจนภิเษกวิทยาลัย สุพรรณบุรี</p>
              <p>จังหวัดที่ตั้งสถาบัน : สุพรรณบุรี</p>
              <p>เกรด : 3.00</p>
            </div>
          </div>
...
<div class="section" id="reference">
  <div class="container cc-reference">
    <div class="h4 mb-4 text-center title">ฝึกอบรม</div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header">
                ...
                <div class="h5 pt-2"></div>
                <p class="category"></p>
              </div>
              <div class="col-lg-10 col-md-9">
                <h3>ศูนย์เทคโนโลยีสารสนเทศ กรมชลประทาน</h3>
                <p>หลักสูตร network mikotik</p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="row">
              ...
              <div class="col-lg-10 col-md-9">
                <h3>ศูนย์เทคโนโลยีสารสนเทศ กรมชลประทาน</h3>
                <p>หลักสูตร การพัฒนาระบบด้วยภาษา PHP</p>
              </div>
            </div>
          </div>
          <!-- <div class="carousel-item">
  ...
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png');">
    ...
    <footer class="footer">
      <div class="container text-center">
        <!-- <a class="cc-facebook btn btn-link" href="https://www.facebook.com/tawatchaihona" target="_blank">
      ...
      <div class="h4 title text-center">Tawatchai</div>
      <div class="text-center text-muted">
        <p>&copy; Tawatchai CV. All rights reserved.</p>
      </div>
    </footer>
